...
import com.refactoringlife.auth.features.forgotpassword.data.dto.request.UserOtpRequest
import com.refactoringlife.auth.features.forgotpassword.data.dto.request.UserVerifyCodeRequest
import com.refactoringlife.auth.features.forgotpassword.data.dto.response.UserOtpResponse
...
class RecoverPasswordServiceImp {
    suspend fun sendEmail(userOtpSendRequest: UserOtpRequest): AsyncResult<UserOtpResponse?, Exception> {
        return try {
